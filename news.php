...
<form method="GET" action="ht_ex.php">

<b><c style="color:brown;font-size:20px"><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspPost your Reviews:</c></b>
<br>
...
<br><br>
<input  type="submit" name="submit" value="post" class="bk_nw1" onclick="ajax()"></input>
<br><br>
</form>
</div><br>
<?php
...
if(isset($_GET["submit"]))
{
    ...
    $result2=mysqli_query($con,"INSERT INTO review (review)VALUES ('$abc')");
    $result = mysqli_query($con,"select review from review");
...
/*<div style="background-color:#C4B28F;width:650px;height:100px;margin-left:50px;border-radius: 20px;border:solid 5px black;" >
